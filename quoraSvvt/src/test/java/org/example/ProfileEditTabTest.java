...
public class ProfileEditTabTest {
    public static void main(String[] args) {
        ...
        WebElement edit = driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div[2]/div/div[3]/div/div/div[7]/div/div[1]/div"));
        edit.click();

        // Check if Edit tab is loaded
        String currentUrl = driver.getCurrentUrl();
        if (currentUrl.contains("/log")) {
            System.out.println("User successfully navigated to the Edit tab");
        } else {
            System.out.println("User failed to navigate to the Edit tab");
        }
