...
public class ProfileActivityTabTest {
    public static void main(String[] args) {
        ...
        WebElement activity = driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div[2]/div/div[3]/div/div/div[8]"));
        activity.click();

        // Check if activity tab is loaded
        String currentUrl = driver.getCurrentUrl();
        if (currentUrl.contains("/activity")) {
            System.out.println("User successfully navigated to the Activity tab");
        } else {
            System.out.println("User failed to navigate to the Activity tab");
        }
