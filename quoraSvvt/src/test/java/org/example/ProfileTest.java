...
public class ProfileTest {
    public static void main(String[] args) {
        ...
        if (currentUrl.contains("/profile/SvvtQP")) {
            System.out.println("User successfully navigated to the Profile page");
        } else {
            System.out.println("User failed to navigate to the Profile page");
        }
